(function () {
    ...
    var basicBot = {
        ...
        name: "simpleBot",
        loggedInID: null,
        scriptLink: "https://raw.githubusercontent.com/l96alex/simplebot/master/simplebot.js",
        ...
        chatUtilities: {
            ...
            spam: [
                'zuera', 'zueira',
                'zueria', 'aehoo', 'aheu', 'alguem', 'algum', 'brazil', 'zoeira', 'fuckadmins',+++++++++++++++++++++++++++ 'vaisefoder', 'huenaarea',
            ...
            sourceCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat('/me This bot was created by Mikhan.");
                    }
                }
            },
